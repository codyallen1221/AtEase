...
- Browser localStorage
  No frameworks, no backend, no paid services.
...
This project stores all data locally in the browser. Clearing browser storage or switching devices will reset the data.
